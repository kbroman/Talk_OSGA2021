...
\figh{Figs/sex_protein.pdf}{0.95}
  ...
  \note{
    ...
    For this particular data set, there are a number of females
...
\begin{frame}[c]{mRNA $\leftrightarrow$ protein mix-ups method}
...
\begin{frame}[c]{DNA $\leftrightarrow$ mRNA correlations}
...
\begin{frame}[c]{DNA $\leftrightarrow$ mRNA similarity matrix}
...
\begin{frame}[c]{DNA $\leftrightarrow$ mRNA similarities}
...
\begin{frame}[c]{DNA $\leftrightarrow$ mRNA}
...
\begin{frame}[c]{DNA $\leftrightarrow$ protein}

...
text(mean(x1), y1[1]-ytgap, "pQTL genotypes", cex=cex_main, col=maincolor, font=2)
text(x1[1]-xtgap, mean(y1), "DNA samples", srt=90)
text(mean(x1), y1[2]+0.5+ytgap, "pQTL")

rect(x2[1], y1[1], x2[2], y2[2])
text(mean(x2), y1[1]-ytgap, "proteomics traits", cex=cex_main, col=maincolor, font=2)
text(x2[1]-xtgap, mean(y2), "protein samples", srt=90)
text(mean(x2), y2[2]+ytgap, "proteins with strong pQTL")
...
text(x3[1]-xtgap, mean(y1), "protein level", srt=90)
text(mean(x3), y1[2]+2.5*ytgap, "pQTL genotype")
...
text(mean(x1), y3[1]-ytgap, "predicted protein levels", cex=cex_main, col=maincolor, font=2)
text(x1[1]-xtgap, mean(y3), "DNA samples", srt=90)
text(mean(x1), y3[2]+ytgap, "proteins")


rect(x2[1], y4[1], x2[2], y4[2])
text(mean(x2), y4[1]-ytgap, "proteomics traits", cex=cex_main, col=maincolor, font=2)
...
file <- here("Figs", "gvp_mixup_scheme.pdf")
